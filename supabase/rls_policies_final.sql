-- ============================================
-- COMPREHENSIVE RLS POLICIES - PRODUCTION READY
-- Date: November 4, 2025
-- ============================================
-- This file contains all RLS policies needed for the application
-- It can be safely applied to overwrite existing policies
...
-- This is needed for various lookups and doesn't expose sensitive data
...
GRANT SELECT, INSERT ON applications TO anon; -- For public application forms
