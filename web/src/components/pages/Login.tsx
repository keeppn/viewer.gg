        ...
        <div className="bg-[#1E1E1E] border border-white/10 rounded-2xl shadow-2xl p-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-4 px-6 py-4 bg-[#9146FF] hover:bg-[#7d3dd9] text-white font-semibold rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-[#9146FF]/20"
            >
              <TwitchIcon />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-4 px-6 py-4 bg-white hover:bg-gray-100 text-gray-900 font-semibold rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg"
            >
              <GoogleIcon />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-4 px-6 py-4 bg-[#5865F2] hover:bg-[#4752c4] text-white font-semibold rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-[#5865F2]/20"
            >
              <DiscordIcon />
              <span>Continue with Discord</span>
            </button>

            {/* Dev Mode Button - Only for development */}
            {process.env.NODE_ENV === 'development' && (
              <button
                onClick={handleDevMode}
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-500 hover:to-orange-500 text-white font-medium rounded-xl transition-all duration-200 hover:scale-105 border-2 border-yellow-400"
              >
                <span>🔧</span>
