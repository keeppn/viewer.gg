...
const SignUpPage: React.FC<SignUpPageProps> = ({ onSignUp, onSignInWithProvider }) => {
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#387B66]/10 border border-[#387B66]/30 rounded-full mb-4">
              ...
              <span className="text-sm text-[#387B66] font-semibold">Create Account</span>
            </div>
            <h3 className="text-3xl font-bold text-white mb-2">Join Viewer.gg</h3>
            <p className="text-gray-400">Start managing your tournaments today</p>
          </div>
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#1a1f2e] text-gray-500 font-medium">or sign up with email</span>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/login" className="text-[#387B66] hover:text-[#4a9080] font-semibold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
