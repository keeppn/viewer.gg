  ...
  return (
    <Link href={path}>
      ...
      >
        ...
        <motion.div 
          className={`w-6 h-6 ${isActive ? 'text-[#FFCB82]' : 'text-gray-400 group-hover:text-[#FFCB82]'}`}
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="relative w-64 bg-gradient-to-b from-[#1E1E1E] to-[#1A1A1A] p-6 flex-shrink-0 flex flex-col shadow-2xl border-r border-white/5 backdrop-blur-xl">
      {/* Logo Section */}
      <motion.div 
